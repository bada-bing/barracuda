...
func (p *Parser) ParseStatement() ast.Statement {
	...
	default:
		// if neither let nor return assume expression statement
...
func (p *Parser) parseExpressionStatement() *ast.ExpressionStatement {
	...
	// semicolons are optional, if nextToken semicolon go over it
...
func (p *Parser) parseExpression(precedence int) ast.Expression {
	prefix := p.prefixParseFns[p.currentToken.Type] // unary operator or identifier or int
...
func (p *Parser) parsePrefixExpression() ast.Expression {
	...
	expression.Right = p.parseExpression(LOWEST) // recursion
	return expression
}
